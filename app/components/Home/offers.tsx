...
const Offers = () => {
  return (
    <section className="p-6 bg-gray-300">
      <h2 className="text-3xl font-bold mb-4">Hotels selected for you</h2>
        ...
        {hotels.map((hotel) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full p-3 text-white">
              ...
              <p className="text-lg">{hotel.nameAr}</p>
              <div className="flex justify-between items-center mt-2 text-xs">
                <span> &#9733; No ratings</span>
                <span className="bg-[#003243] px-3 py-1 rounded text-white text-sm flex items-center gap-1">
                  Night /
                  <Image
                    src="/Riyal_White.png"
                    alt="Riyal"
